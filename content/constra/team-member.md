...
---
**Team Slider** <br>
1. Customize the team member slider item from about page.
...
<div id="team-slide" class="team-slide">
	...
	<div class="ts-team-content">
		...
		<p class="ts-description">Nats Stenman began his career in....</p>
...
**Team page** <br>
2. Customize the team member item from team page.
...
<div class="ts-team-content-classic">
	<h3 class="ts-name">Nats Stenman</h3>
	<p class="ts-designation">Chief Operating Officer</p>
	<p class="ts-description">Nats Stenman began his career...</p>
	<div class="team-social-icons">
		<a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
		<a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
		<a target="_blank" href="#"><i class="fab fa-linkedin"></i></a>
